...
| 5 | Fibonacci Number | EASY | 1 / 1 | 🟢 Passed | [View Solution](./fibonacci-number/Main.java) | [View Report](./fibonacci-number/README.md) |
| 6 | Contains Duplicate | EASY | 1 / 1 | 🟢 Passed | [View Solution](./contains-duplicate/Main.java) | [View Report](./contains-duplicate/README.md) |
| 7 | Valid Anagram | EASY | - / 1 | 🔴 Pending | - | - |
| 8 | Merge Sorted Array | EASY | - / 1 | 🔴 Pending | - | - |
| 9 | Remove Duplicates from Sorted Array | EASY | 1 / 1 | 🟢 Passed | [View Solution](./remove-duplicates/Main.java) | [View Report](./remove-duplicates/README.md) |
...
| 18 | Pascal's Triangle | EASY | - / 1 | 🔴 Pending | - | - |
| 19 | Best Time to Buy and Sell Stock | EASY | 1 / 1 | 🟢 Passed | [View Solution](./best-time-stock/Main.java) | [View Report](./best-time-stock/README.md) |
| 20 | Missing Number | EASY | 1 / 1 | 🟢 Passed | [View Solution](./missing-number/Main.java) | [View Report](./missing-number/README.md) |
| 21 | Reverse Vowels of a String | EASY | - / 1 | 🔴 Pending | - | - |
| 22 | First Unique Character in a String | EASY | 1 / 1 | 🟢 Passed | [View Solution](./first-unique-char/Main.java) | [View Report](./first-unique-char/README.md) |
| 23 | Find Pivot Index | EASY | 1 / 1 | 🟢 Passed | [View Solution](./find-pivot-index/Main.java) | [View Report](./find-pivot-index/README.md) |
| 24 | Is Subsequence | EASY | - / 1 | 🔴 Pending | - | - |
